...
- AO3 branch, with AO3 ready code. In that one you'll find the CSS and two versions of HTML - one that can be used by anybody and another that's meant to be used with <a href="https://lazycats.dev">Podfic Posting Helper</a> and offers a measure of automation.
